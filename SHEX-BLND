...
#### LOGO ####
logo = """
\x1b[31;1m   This Tool Craete by SHEX_BLND but recode by SHEX_CRACKER /\Your id is active
\x1b[31;1m 
\x1b[31;1m 
\x1b[31;1m
\x1b[31;1m  
...
RH = """
\x1b[31;1m   __This Tool Create by SHEX_BLND but Recode by SHEX_CRACKER/\Your id is active
\x1b[37;1m 
\x1b[31;1m
\x1b[37;1m  
\x1b[31;1m 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Daxl Bwet ba ID " + username #SHEX=BLND
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96m Passwordakat Halaya"
            print " Tkaya Bba andam la SHEX_CRACKER Ta ID w Pass Dast Kawet"
    else:
...
def menu():
	...
	#INFORMATION OF USER
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\x1b[32;1mSHEX*BLND/ Name >>"+namefb
	print "\x1b[34;1mSHEX*BLND/ ID >>"+id
	print '\x1b[33;1mSHEX*BLND/ TotalSub >>'+subid
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print ""
	print "===================="
...
def option():
	unikers = raw_input("\n\x1b[31;1mSHEX\x1b[37;1mBLND>>\x1b[33;1m")
	if unikers =="":
...
def startgrab():
	...
	p = ThreadPool(30)
	p.map(main, id)
        anime("\x1b[32;1m>>>>>>>>>>>>>>>\x1b[31;1mSHEX\x1b[37;1BLND>>\x1b[32;1m<<<<<<<<<<<<<<<")
